...
async def get_report(data: ReportData):
    ...
    - Provide a 1–2 sentence justification, quoting or paraphrasing the rubric language. At the end of each section, offer one sentence suggesting a specific practice or strategy for improvement based on the student’s revision behavior. Make sure you evaluate based on time constraints and the fact that it is for undergraduate level of users as well as a 250-300 word essay.
    PART-2: Revision Potential (Analytic Feedback Rubric Best Practices. Include insights into writing behaviour)
    Please highlight specific insights based on how the essay evolved — e.g., major rewrites, moments of hesitation, or structural revisions. Specifically reference keystrokes, pauses, or snapshot differences **only where meaningful** to explain the student’s development and revision patterns. In your evaluation, use meaningful writing process evidence to support your analysis. Reference notable pauses, revision bursts, rewriting patterns, or changes in structure or argument—especially where they reflect decision-making, confusion, or problem-solving. Compare early and late versions of paragraphs to detect deeper revisions such as restructuring of ideas, evolution of tone, or shifts in argumentative strategy. If long pauses or multiple rewrites are observed near the introduction or conclusion, consider whether the student faced uncertainty, cognitive overload, or emotional hesitation in expressing their ideas.
    ...
    Assume the student is a language learner. Keep the tone neutral, constructive, and focused on learning potential. Limit each section to 2–4 sentences and Revision section to 7-8 sentences. Avoid generic commentary; instead, interpret the writing behavior to reveal cognitive and compositional development. Discuss spelling or grammar issues only if they are present in the final draft or if recurring patterns suggest deeper challenges with language mastery. This is a timed task with a 20-minute limit and 200–300 word count. Evaluate the thesis and argumentation with this constraint in mind. A fully elaborated argument is not expected; rather, assess whether the student clearly expressed a main idea and maintained a consistent perspective within the given limits.
    """
)
